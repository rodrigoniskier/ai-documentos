...
DOCUMENT_VISUAL_QA_ENABLED = env_bool("DOCUMENT_VISUAL_QA_ENABLED", True)
DOCUMENT_VISUAL_QA_BLOCK_ON_FAILURE = env_bool(
    "DOCUMENT_VISUAL_QA_BLOCK_ON_FAILURE", True
)
DOCUMENT_VISUAL_QA_MODEL = os.getenv("DOCUMENT_VISUAL_QA_MODEL", OPENAI_MODEL)
